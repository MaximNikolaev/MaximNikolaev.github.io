...
### **Главный разработчик баз данных** в ООО "Компьютайм"
...
### **Главный разработчик баз данных** в [ФГБУ Федеральный Научно-Клинический Центр ФХМ ФМБА России](http://rcpcm.org/)
...
АНО ДПО "Национальный исследовательский институт дополнительного образования и профессионального обучения"</br>
_Менеджер в здравоохранении, 2020_

Московский институт современного академического образования</br>
_Экономист-аналитик, 2020_

#### [Национальный исследовательский ядерный университет "МИФИ"](https://mephi.ru/)</br>
_кафедра Микро- и наноэлектроники, Инженер-физик, 2008_

Повышение квалификации, курсы
-----------------

- Разработка серверной части приложений PostgreSQL, _Центр Специалист 2022_
...
- Работал с биоинформатическими данными на Debian Linux в МГУ, результатом стала статья в журнале Биохимия, 2016.
  _https://biochemistrymoscow.com/ru/archive/2016/81-01-0115/_
...
- Прохожу программу профессиональной переподготовки по Java+PostgreSQL в specialist.ru