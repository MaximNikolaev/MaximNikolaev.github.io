...
### **Техлид, Ведущий консультант по бухгалтерскому и финансовому учетам** в компании-партнере 1C International

*Январь 2023 - наст. вр.* (9 месяцев)

- Работа с конфигурациями 1C Perform, 1C Drive International / Turkish Edition с программным кодом на английском языке
- Работа с ключевыми сотрудниками клиентов и демонстрация результатов проекта владельцам компаний на английском языке
- Организован процесс разработки 1C Drive International / Turkish Edition с использованием хранилищ конфигурации и поставок
- Запущен оперативный контур (банк, закупка, продажа, склад) в базах 1C Drive для нескольких стран
- Подготовлены шаблоны проводок для отражения проводок на турецком и международном (МСФО/IFRS) планах счетов
- Совместно с главным бухгалтером подготовлена структура статей для отчета о Доходах и расходах для Группы компаний
- Постановка задач программистам и консультантам (5 сотрудников/внешних подрядчиков)
- Обновление нетиповой конфигурации и консультирование клиентов по 1С Зарплата и Управление Персоналом 3 Казахстан
- Разработка дополнительных обработок, отчетов, печатных форм на нескольких языках
